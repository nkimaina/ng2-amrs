...
@Component({
  ...
  templateUrl: '../../../hiv-care-lib/hiv-monthly-summary-indicators/hiv-summary-report-base.html'
})

export class HivSummaryMonthlyIndicatorsComponent extends HivMonthlySummaryIndicatorBaseComponent
implements OnInit {
  public data = [];
  public sectionsDef = [];
  ...
  constructor(public hivIndicatorsResourceService: HivMonthlySummaryIndicatorsResourceService,
    ...
    super(hivIndicatorsResourceService, dataAnalyticsDashboardService, appFeatureAnalytics);
